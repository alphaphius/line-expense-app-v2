...
const versionedAssets = ['styles.css','workhub-modules.css','config.js','api.js','image-optimizer.js','protected-access.js','receipts.js','workhub-core.js','tasks.js','payroll.js','report-xlsx.js','reports.js','app.js','pwa.js'];
...
for (const file of ['api.js', 'image-optimizer.js', 'protected-access.js', 'receipts.js', 'workhub-core.js', 'tasks.js', 'payroll.js', 'report-xlsx.js', 'reports.js', 'app.js', 'pwa.js']) {
  await build({
