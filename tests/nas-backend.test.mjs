...
test('bill buyer company validation rejects lookalike names and requires branch qualifiers', () => {
  ...
  assert.equal(companyNamesMatch('บริษัท วิศวกรรมธรณีและฐานราก จำกัด (สำนักงานใหญ่)', 'บริษัทวิศวกรรมธรณีและฐานราก จำกัด', 'สำนักงานใหญ่', '0105536084347', '0105536084347'), true);
  assert.equal(companyNamesMatch('บริษัท วิศวกรรมธรณีและฐานราก จำกัด (สำนักงานใหญ่)', 'บริษัทวิศวกรรมธรณีและฐานราก จำกัด', 'สำนักงานใหญ่', '0105536084347', '0105536084999'), false);
  assert.equal(companyNamesMatch('บริษัท วิศวกรรมธรณีและฐานราก จำกัด (สำนักงานใหญ่)', 'บริษัทวิศวกรรมและฐานราก จำกัด', 'สำนักงานใหญ่', '0105536084347', '0105536084347'), false);
});
